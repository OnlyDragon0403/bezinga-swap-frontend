  ...
  const tooltipContent = (
    <>
      <Text color="textColor">
        The Multiplier represents the proportion of SLT rewards each stake
        receives, as a proportion of the SLT produced each block.
      </Text>
      <Text color="textColor" my="24px">
        For example, if a 1x stake received 1 SLT per block, a 40x stake would
        receive 40 SLT per block.
      </Text>
      <Text color="textColor">
        This amount is already included in all APR calculations for the stake.
      </Text>
    </>
  );
